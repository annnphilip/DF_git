...
{
    public abstract class Discussion_forumWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Discussion_forumWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Discussion_forumWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Discussion_forumDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Discussion_forumDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Discussion_forumDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Discussion_forumDbContext, Task<T>> func)
        {
            T result;
